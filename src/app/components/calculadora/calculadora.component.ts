...
export class CalculadoraComponent implements AfterViewInit {
  ...
  constructor(private mediaService: MediaService, private router: Router, private
renderer: Renderer2) { }
  ...
  calcularMedia(): void {
    if (this.nota1 === null || this.nota2 === null || this.nota3 === null || this.nota4 ===
      null) {
      this.exibirErro('Preencha todas as notas!');
      return;
    }

    if (this.nota1 < 0 || this.nota1 > 10 || this.nota2 < 0 || this.nota2 > 10 || this.nota3 <
      0 || this.nota3 > 10 || this.nota4 < 0 || this.nota4 > 10) {
  ...
  private exibirErro(mensagem: string): void {
    this.renderer.setProperty(this.mensagemErro.nativeElement, 'textContent',
      mensagem);
